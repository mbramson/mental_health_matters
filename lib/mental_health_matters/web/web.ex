defmodule MentalHealthMatters.Web do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MentalHealthMatters.Web
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/mental_health_matters/web/templates",
                        namespace: MentalHealthMatters.Web
