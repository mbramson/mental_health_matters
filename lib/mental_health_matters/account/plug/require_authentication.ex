defmodule MentalHealthMatters.Plug.RequireAuthentication do
  @moduledoc """
  ...
  """
  alias MentalHealthMatters.Router.Helpers, as: Routes
  import Plug.Conn
  ...
  defp redirect_to_sign_in(conn) do
    ...
    |> Phoenix.Controller.redirect(to: "/signin/new")
    |> halt
  end
end
